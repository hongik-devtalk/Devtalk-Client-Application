  ...
  return (
    ...
    >
      ...
      <div className="body-2-medium text-grey-200 text-left">
        <p className="text-gradient">ChatGPT 3년차,</p>
        <p>
          LLM은 더욱 어려운 문제를 해결하고 실제 작업을 수행하는 수준으로 발전했습니다.
          <br />
        </p>
        <br />
        <p>
        ...
        <p className="text-gradient">LLM은 어쩌다 이렇게 똑똑해졌을까요?</p>
        <br />
        <p>LLM의 놀라운 능력의 비밀,</p>
        <p className="text-gradient">추론(Reasoning)과 에이전트(Agent)</p>
        <p>라는 핵심 키워드를 쉽고 명확하게 알아봅시다!</p>
      </div>
    </div>
  );
};
